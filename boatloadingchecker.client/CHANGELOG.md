...
- Create Angular project with ng: `ng new boatloadingchecker.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`boatloadingchecker.client.esproj`).
